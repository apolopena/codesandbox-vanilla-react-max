...
const InnerForm = ({
  ...
  <form onSubmit={handleSubmit}>
    <WingBlank>
      ...
      <CheckboxWithError
        title="checkbox demo"
        onChange={(val) => setFieldValue("checkboxDemo", val)}
        onBlur={() => setFieldTouched("checkboxDemo", true)}
        data={[
          { value: "100", label: "one hundered" },
          { value: "200", label: "two hundered" }
        ]}
        value={values.checkboxDemo}
        touched={touched.checkboxDemo}
        errors={errors.checkboxDemo}
      />
      <WhiteSpace />
...
const MyForm = withFormik({
  ...
  validate: (values, props) => {
    ...
    if (!values.checkboxDemo) {
      errors.checkboxDemo = "Required";
    }
